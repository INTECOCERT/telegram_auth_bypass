...
/*static int _print_auth_key_id(FILE *fd, long long mitm_auth_key_id) {

  unsigned int i;

  for(i=0; i<sizeof(long long); i++) {
    fprintf(fd, " %02x", (unsigned int) (0xFF & (mitm_auth_key_id >> i)));
  }
  fprintf(fd, "\n");
  return 0;
